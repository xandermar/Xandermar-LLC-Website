...
{% include responsive-picture.html src="/assets/images/ai23.jpg" alt="Illustration representing faster quote generation and structured sales responses" class="hero-image-full" width="1200" height="500" loading="lazy" decoding="async" widths=site.responsive_image_defaults.widths sizes=site.responsive_image_defaults.sizes %}
...
{% include responsive-picture.html src="/assets/images/ai24.jpg" alt="Illustration representing small-business sales systems organized with AI and CRM automation" class="hero-image-full" width="1200" height="500" loading="lazy" decoding="async" widths=site.responsive_image_defaults.widths sizes=site.responsive_image_defaults.sizes %}
...
{% include responsive-picture.html src="/assets/images/ai25.jpg" alt="Illustration representing consistent customer communication and proposal delivery" class="hero-image-full" width="1200" height="500" loading="lazy" decoding="async" widths=site.responsive_image_defaults.widths sizes=site.responsive_image_defaults.sizes %}
...
{% include responsive-picture.html src="/assets/images/ai26.jpg" alt="Illustration representing business impact from automated CRM and quoting workflows" class="hero-image-full" width="1200" height="500" loading="lazy" decoding="async" widths=site.responsive_image_defaults.widths sizes=site.responsive_image_defaults.sizes %}
...
{% include responsive-picture.html src="/assets/images/ai27.jpg" alt="Illustration representing a faster and more organized AI-enabled sales process" class="hero-image-full" width="1200" height="500" loading="lazy" decoding="async" widths=site.responsive_image_defaults.widths sizes=site.responsive_image_defaults.sizes %}
